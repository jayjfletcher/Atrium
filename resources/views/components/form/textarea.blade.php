...
<div @class(['flex flex-col gap-1.5 text-on-surface dark:text-on-surface-dark', $wrapper ?? 'w-full'])>
    ...
    <textarea
        ...
        {{ $attributes->class([
            'w-full rounded-radius border bg-surface px-3 py-2 text-sm text-on-surface-strong shadow-xs transition placeholder:text-on-surface/60 focus:outline-none focus:ring-3 disabled:cursor-not-allowed disabled:opacity-60 dark:bg-white/5 dark:text-on-surface-dark-strong dark:placeholder:text-on-surface-dark/60',
