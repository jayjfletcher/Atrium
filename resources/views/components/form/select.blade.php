...
<div @class(['flex flex-col gap-1 text-on-surface dark:text-on-surface-dark', $wrapper ?? 'w-full'])>
    ...
    <select
        ...
        {{ $attributes->class([
            'w-full appearance-none rounded-radius border bg-surface-alt px-2 py-2 text-sm focus-visible:outline-2 focus-visible:outline-offset-2 disabled:cursor-not-allowed disabled:opacity-75 dark:bg-surface-dark-alt/50',
